...
export default function Spinner({ fill, size, color, className, props }) {
  return (
    <svg
      width={size ? size : "32"}
    ...
    >
      <g>
        <g>
          <path
            d="M222.566,108.636C228.926,41.79,190.599,6.078,160.052,0.878c-25.159-4.282-41.66,9.115-41.66,9.115l-9.727,79.115
